...
:- func map_semidet_fold(func(K, V, A) = A, map(K, V), A) = A.
:- mode map_semidet_fold(in(func(in, in, in) = out is det), in, in) = out
	is det.
:- mode map_semidet_fold(in(func(in, in, in) = out is semidet), in, in) = out 
	is semidet.
